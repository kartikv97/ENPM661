...
if check_Obstacle(goal[0], goal[1]):
    ...
    if flag is False:
        ...
        def load_Images():
            ...
            out = cv2.VideoWriter('Output_video.avi', fourcc, 20.0, (728, 511))
        ...
        count = 0
        for expnode in range(len(ExploredNodeList)):
            try:
                parent_x = ExploredParentNodeList[expnode*500][0]
                parent_y = ExploredParentNodeList[expnode*500][1]
                node_x = ExploredNodeList[expnode*500][0]
                node_y = ExploredNodeList[expnode*500][1]
